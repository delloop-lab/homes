...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_cleaning_email_logs_cleaner_id ON cleaning_email_logs(cleaner_id);
CREATE INDEX IF NOT EXISTS idx_cleaning_email_logs_cleaner_email ON cleaning_email_logs(cleaner_email);
CREATE INDEX IF NOT EXISTS idx_cleaning_email_logs_status ON cleaning_email_logs(status);
CREATE INDEX IF NOT EXISTS idx_cleaning_email_logs_sent_at ON cleaning_email_logs(sent_at);
