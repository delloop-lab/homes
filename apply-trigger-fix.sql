-- Run this SQL in your Supabase SQL Editor to fix the booking update timeout issue
-- This optimizes the overlap trigger to only run when dates actually change
...
WHERE trigger_name = 'check_booking_overlap_trigger';
